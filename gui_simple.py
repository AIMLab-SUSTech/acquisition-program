...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.save_path_row = QtWidgets.QHBoxLayout()
        self.save_path_row.setContentsMargins(0, 0, 0, 0)
        self.save_path_row.addWidget(self.save_path)
        self.save_path_browse = QtWidgets.QPushButton(self.layoutWidget3)
        self.save_path_browse.setObjectName("save_path_browse")
        self.save_path_browse.setText("...")
        self.save_path_browse.setFixedWidth(30)
        self.save_path_row.addWidget(self.save_path_browse)
        self.verticalLayout_4.addLayout(self.save_path_row)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.scan_mode.setItemText(1, _translate("MainWindow", "圆形"))
